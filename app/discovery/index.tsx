...
const TrendingFrontPage = () => {
  ...
  const searchField = () => {
    return (
      <View
        ...
        className="mx-4 my-2 rounded-2xl px-2 py-2.5">
  ...
  const renderTag = ({ item }: { item: string }) => (
    <TouchableOpacity
      ...
      accessibilityHint="Filter articles by tags"
  ...
  const renderCard = ({ item }: { item: TrendingArticle }) => (
    <Card
      ...
      <View style={styles.cardContent} className="border-0 border-border p-1">
        <Thumbnail
        ...
        <View
          style={[styles.textContainer, { height: height / 9 }]}
          ...
          <Text
            ...
            className="text-text capitalize leading-tight">
            {item.title}
          </Text>
          <Text
            variant="caption1"
  ...
  return (
    <View className="flex-1">
      ...
      <Text variant="heading" style={fontStyles.dmSansSemiBold} className="text-text mx-4 my-2">
        Discovery
      </Text>
